...
class GuiFields():
    ...
    def __init__(self, frame):
        ...
        self.field_types = BasicFields.SupportedTypes
        self.field_type.set(self.field_types[0])
        self.field_name.set("my_field")
        self.table_name.set(Meta.DEFAULT_TABLE)
        self.zlb = None
        self.results = None
        self._body(frame)
    ...
    def put_results(self, table_def):
        ...
        '''
        if not isinstance(table_def, BasicTable):
            return False
        self.table_name.set(table_def.get_table_name())
        for field in table_def.fields:
            if field == "ID":
                continue
            entry = field + ":" + table_def.fields[field]
    ...
    def _apply(self):
        ...
        self.results = BasicTable(name=self.table_name.get())
